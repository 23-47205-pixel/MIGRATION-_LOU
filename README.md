A Google Classroom-like demo built entirely in a single HTML file with JavaScript and local storage. This interactive simulation includes assignment submissions, learning modules, quizzes, grade management, and role-based access (Teacher/Student).
